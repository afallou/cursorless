...
#### Target Descriptors
([PartialTargetDescriptor.types.ts](packages/common/src/types/command/PartialTargetDescriptor.types.ts))
```typescript
...
**Programming Constructs** ([PartialTargetDescriptor.types.ts](packages/common/src/types/command/PartialTargetDescriptor.types.ts), [spoken_forms.json](cursorless-talon/src/spoken_forms.json)):
